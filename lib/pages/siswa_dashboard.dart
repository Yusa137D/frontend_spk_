...
class SiswaDashboard extends StatelessWidget {
  ...
  Widget _buildStatCards() {
    return Row(
      children: [
        _statCard(Icons.person_rounded, const Color(0xFF2563EB), const Color(0xFFEFF6FF), "Peran Akun", user['role']),
        _statCard(Icons.assignment_rounded, const Color(0xFFF59E0B), const Color(0xFFFFFBEB), "Tugas", "Menilai Guru"),
        _statCard(Icons.check_circle_rounded, const Color(0xFF22C55E), const Color(0xFFF0FDF4), "Status", "Aktif"),
      ],
    );
  }
