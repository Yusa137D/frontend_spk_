...
class KepsekDashboard extends StatefulWidget {
  final Map user;
  const KepsekDashboard({super.key, required this.user});
    ...
    return Row(
      ...
      children: [
        Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          const Text("Dashboard Kepala Sekolah", style: TextStyle(fontSize: 22, fontWeight: FontWeight.w800, color: _textPrimary)),
