...
class SidebarWidget extends StatelessWidget {
  ...
  bool get _isKepsek => user['role'].toString().toLowerCase().contains('kepala') || user['role'].toString().toLowerCase().contains('kepsek');
        ...
        children: [
          ...
          if (_isGuru || _isSiswa)
            _sideItem(Icons.assignment_rounded, "Kuesioner", false, () {
              Navigator.push(context, MaterialPageRoute(builder: (_) => DaftarGuruKuesionerPage(idUser: user['id_user'])));
            }),
          ...
          if (_isAdmin || _isKepsek) ...[
            ...
            if (_isAdmin) ...[
              _sideItem(Icons.manage_accounts_rounded, "Kelola Guru", false, () {
            ...
            _sideItem(Icons.picture_as_pdf_rounded, "Cetak Laporan", false, _downloadLaporan),
          ],
          const Spacer(),
          InkWell(
